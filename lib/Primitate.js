...
var PrimitateClass = (function () {
     ...
     */
    PrimitateClass.prototype.subscribe = function (listener, pickers) {
        var _this = this;
        if (pickers === void 0) { pickers = [identity]; }
        return this._PrimitateTree.addListener(listener, pickers, function () { return _this._State_Current; });
    };
