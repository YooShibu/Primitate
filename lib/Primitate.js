...
var PrimitateTree = (function () {
    ...
    PrimitateTree.prototype.addListener = function (listener, pickers, getState) {
        var _this = this;
    ...
    PrimitateTree.prototype._emitListener = function (Item_PrimitateTree, getCurrentState) {
    ...
    PrimitateTree.prototype.emitListener = function (pick, getCurrentState) {
        var _this = this;
        this._isEmitting = true;
        var Item_PrimitateTree = pick(this._tree);
        clearTimeout(Item_PrimitateTree[Key_ID_Timer_Initial]);
        Item_PrimitateTree[Key_ID_Timer_Initial]
            = setTimeout(function () { return _this._emitListener(Item_PrimitateTree, getCurrentState); }, 0);
    };
...
var PrimitateClass = (function () {
     ...
     */
    PrimitateClass.prototype.subscribe = function (listener) {
        var _this = this;
        var pickers = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            pickers[_i - 1] = arguments[_i];
        }
        return this._PrimitateTree.addListener(listener, pickers.length > 0 ? pickers : [identity], function () { return _this._State_Current; });
    };
