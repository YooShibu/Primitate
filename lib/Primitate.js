...
var state;
function startPrimitate(initialState, reInitialize) {
    if (reInitialize === void 0) { reInitialize = false; }
    var pickers = {};
    var listeners = {};
    ...
    function createAction(pick) {
        ...
        return function (action) {
            return function (next) {
                ...
                var currentState = utility_1.deepFreeze(action(prevState, next, initialState));
    ...
    // main
    // **********
    if (utility_1.isExisty(state) && reInitialize === false)
        throw new Error("You have already started Primitate. Write like this 'startPrimitate(initialState , true)'"
