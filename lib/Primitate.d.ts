export declare type action<T> = <U>(action: (prevState: T, next?: U, initialState?: T) => T) => (next: U) => {
    value: () => T;
};
...
declare function startPrimitate<T extends {
    ...
    createAction: <U>(pick: (state: T) => U) => <V>(action: (previousState: U, next?: V, initialState?: U) => U) => (next?: V) => {
        value: () => U;
    };
